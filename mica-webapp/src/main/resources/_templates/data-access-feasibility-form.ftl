...
<body id="data-access-feasibility-page" class="hold-transition sidebar-mini layout-fixed layout-navbar-fixed sidebar-expand-lg">
<!-- Site wrapper -->
      ...
      <div class="row">
        <div class="col-sm-12 <#if dataAccessInstructionsEnabled || (feasibility.variablesSet?? || feasibilityVariablesEnabled)>col-lg-8<#else>col-lg-12</#if>">
          <div class="card card-primary card-outline">
            <div class="card-header d-print-none">
              ...
              <div>
                <#if feasibilityPermissions?seq_contains("EDIT")>
                  ...
                  <#else>
                  <span class="float-end border-start ms-2 ps-2">
                    <a class="btn btn-primary" href="#" onclick="MicaDataAccessForm.save('${dar.id}', 'feasibility', '${feasibility.id}'); return false;"><@message "save"/></a>
            ...
            <#if feasibilityPermissions?seq_contains("EDIT") && !formConfig.readOnly>
              ...
              <div class="modal-content">
                ...
                <div class="modal-footer justify-content-between">
                  ...
                  <button type="button" class="btn btn-primary" data-bs-dismiss="modal"
                          onclick="MicaDataAccessForm.submit('${dar.id}', 'feasibility', '${feasibility.id}')"><@message "confirm"/></button>
                </div>
              </div>
              <!-- /.modal-content -->
            </div>
                ...
                <div class="card-body">
                    <#if feasibility.variablesSet??>
                      <a class="btn btn-info" href="${contextPath}/list/${feasibility.variablesSet.id}">
                        ...
                        <span class="badge text-bg-light">${feasibility.variablesSet.identifiers?size}</span>
                      </a>
                      <#if feasibilityPermissions?seq_contains("EDIT")>
