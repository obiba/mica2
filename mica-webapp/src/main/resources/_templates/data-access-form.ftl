          ...
          <div class="card card-primary card-outline">
            <div class="card-header d-print-none">
              ...
              <div ng-cloak>
                ...
                <span class="float-end <#if permissions?seq_contains("EDIT_STATUS")>border-right me-2 pe-2</#if>" ng-if="schema.readOnly">
                  <#if diffs??>
                ...
                <div class="card-body">
                  <#if dar.variablesSet??>
                    <a class="btn btn-info" href="${contextPath}/list/${dar.variablesSet.id}">
                      ...
                      <span class="badge text-bg-light">${dar.variablesSet.identifiers?size}</span>
                    </a>
                    <#if permissions?seq_contains("EDIT")>
