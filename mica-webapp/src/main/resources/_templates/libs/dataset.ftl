...
<#macro harmonizationProtocolGeneralInfo dataset>
  <dl class="row mt-3">
      ...
      <#if dataset.model.prospectiveRetrospective??>
        <dt class="col-sm-3">
            <@message "harmonization-protocol.prospective-retrospective.title"/> <i class="fa-solid fa-info-circle" title="Add text"></i>
        </dt>
        <dd class="col-sm-9">
      ...
      <#if dataset.model.qualitativeQuantitative??>
        <dt class="col-sm-3">
            <@message "harmonization-protocol.qualitative-quantitative.title"/> <i class="fa-solid fa-info-circle" title="Add text"></i>
        </dt>
        <dd class="col-sm-9">
