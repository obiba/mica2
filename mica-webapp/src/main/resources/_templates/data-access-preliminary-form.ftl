...
<body id="data-access-preliminary-page" class="hold-transition sidebar-mini layout-fixed layout-navbar-fixed sidebar-expand-lg">
<!-- Site wrapper -->
      ...
      <div class="row">
        <div class="col-sm-12 <#if dataAccessInstructionsEnabled || (preliminary.variablesSet?? || preliminaryVariablesEnabled)>col-lg-8<#else>col-lg-12</#if>">
          <div class="card card-primary card-outline">
            <div class="card-header d-print-none">
              ...
              <div>
                <#if preliminaryPermissions?seq_contains("EDIT")>
                  ...
                  <#else>
                  <span class="float-end border-start ms-2 ps-2">
                    <a class="btn btn-primary" href="#" onclick="MicaDataAccessForm.save('${dar.id}', 'preliminary', '${preliminary.id}'); return false;"><@message "save"/></a>
                    <a class="btn btn-secondary" href="${preliminary.id}"><@message "cancel"/></a>
                  </span>
                  </#if>
                </#if>
            ...
            <#if preliminaryPermissions?seq_contains("EDIT") && !formConfig.readOnly>
              ...
              <div class="modal-content">
                ...
                <div class="modal-footer justify-content-between">
                  ...
                  <button type="button" class="btn btn-primary" data-bs-dismiss="modal"
                          onclick="MicaDataAccessForm.submit('${dar.id}', 'preliminary', '${preliminary.id}')"><@message "confirm"/></button>
                </div>
              </div>
              <!-- /.modal-content -->
            </div>
                ...
                <div class="card-body">
                    <#if preliminary.variablesSet??>
                      <a class="btn btn-info" href="${contextPath}/list/${preliminary.variablesSet.id}">
                        ...
                        <span class="badge text-bg-light">${preliminary.variablesSet.identifiers?size}</span>
                      </a>
                      <#if preliminaryPermissions?seq_contains("EDIT")>
