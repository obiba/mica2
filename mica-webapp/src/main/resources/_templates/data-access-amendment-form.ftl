...
<body id="data-access-amendment-form-page" class="hold-transition sidebar-mini layout-fixed layout-navbar-fixed sidebar-expand-lg">
<!-- Site wrapper -->
      ...
      <div class="row">
        <div class="col-sm-12 <#if dataAccessInstructionsEnabled || (amendment.variablesSet?? || amendmentVariablesEnabled)>col-lg-8<#else>col-lg-12</#if>">
          <div class="card card-primary card-outline">
            <div class="card-header d-print-none">
              ...
              <div>
                <#if amendmentPermissions?seq_contains("EDIT")>
                  ...
                  <#else>
                  <span class="float-end border-start ms-2 ps-2">
                    <a class="btn btn-primary" href="#" onclick="MicaDataAccessForm.save('${dar.id}', 'amendment', '${amendment.id}'); return false;"><@message "save"/></a>
                ...
                <span class="float-end">
                  ...
                  <@dataAccessDownloadButtons wordUrl="${contextPath}/ws/data-access-request/${dar.id}/amendment/${amendment.id}/_word?lang=${.lang}" filesUrl="${contextPath}/ws/data-access-request/${dar.id}/amendment/${amendment.id}/files/_download"/>
            ...
            <#if amendmentPermissions?seq_contains("EDIT") && !formConfig.readOnly>
            ...
            <div class="modal-dialog">
              <div class="modal-content">
                ...
                <div class="modal-footer justify-content-between">
                  <button type="button" class="btn btn-secondary" data-bs-dismiss="modal"><@message "cancel"/></button>
                  <button type="button" class="btn btn-primary" data-bs-dismiss="modal"
                          onclick="MicaDataAccessForm.submit('${dar.id}', 'amendment', '${amendment.id}')"><@message "confirm"/></button>
                </div>
              </div>
              <!-- /.modal-content -->
            </div>
